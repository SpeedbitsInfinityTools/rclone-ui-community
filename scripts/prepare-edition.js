#!/usr/bin/env node
/**
 * Edition Preparation Script for Rclone Director UI
 * 
 * This script prepares the codebase for Docker builds and public repo sync
 * by replacing the multi-server routes with a Community Edition stub.
 * 
...
const DIRECTOR_DIR = path.join(ROOT_DIR, 'rclone-director');
...
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
console.log('🏗️  Rclone Director UI - Community Edition Preparation');
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
console.log('');
...
const routesPath = path.join(DIRECTOR_DIR, 'routes', 'servers.routes.js');
...
console.log('   ✓ Created rclone-director/routes/servers.routes.js (Community stub)');
console.log('');
...
const markerPath = path.join(DIRECTOR_DIR, '.edition');
fs.writeFileSync(markerPath, JSON.stringify(marker, null, 2));
console.log('   ✓ Created rclone-director/.edition marker');
console.log('');

console.log('✅ Community edition preparation complete!');
console.log('');
