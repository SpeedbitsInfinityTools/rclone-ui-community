...
export const ADMIN_PASSWORD_KEY = "adminPassword"; // DEPRECATED: Use SESSION_KEY instead
export const MASTER_KEY = "masterKey"; // DEPRECATED: Use SESSION_KEY instead
export const SESSION_KEY = "sessionKey"; // Random session token (stored on backend)
